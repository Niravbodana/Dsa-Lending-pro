        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {milestones.map((m, i) => (
            <ScrollRevealAlternate key={m.year} index={i} delay={i * 80}>
              <div className="h-full rounded-2xl border border-slate-100 bg-white/80 p-6 shadow-lg backdrop-blur">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          {values.map((v, i) => (
            <ScrollRevealAlternate key={v.title} index={i} delay={i * 70}>
              <div className="flex gap-4 rounded-2xl bg-white/80 p-6 shadow-lg backdrop-blur">

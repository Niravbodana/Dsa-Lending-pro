...
export function LoanGuideMascot({ step, activeField, show }: LoanGuideMascotProps) {
  ...
  return (
    <div className="loan-guide-root pointer-events-none fixed inset-x-0 bottom-4 z-40 flex justify-end px-3 sm:bottom-6 sm:px-6">
      <div className={`loan-guide-wrap pointer-events-auto ${poseClass}`}>
        {/* Cloud thought bubble */}
        <div className="loan-guide-bubble" role="status" aria-live="polite">
          <div className="loan-guide-bubble-cloud">
            <p className="whitespace-pre-line text-sm font-semibold leading-snug text-slate-800">
              {bubbleText}
            </p>
          </div>
        ...
        >
          <svg viewBox="0 0 200 240" className="h-[140px] w-[116px] sm:h-[168px] sm:w-[140px]" aria-hidden>
            <defs>
